...
/**
    ...
    public function index(){
        ...
        $this->pageKeyList = array('id','code','recharge_price','exp_date','status','count','end_time','ctime','is_del','DOACTION');
    ...
    public function addRecharge(){
        ...
        $this->_initTabSpecial();
        $this->pageKeyList = array ('recharge_price','exp_date','end_time','count');
        $this->notEmpty = array ('recharge_price','exp_date','end_time','count');
        if($id){
